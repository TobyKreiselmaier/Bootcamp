...
contract("Upgrade initial implementation with EnergiTokenUpgrade", accounts => {
  ...
  /**
   * Test upgrading EnergiToken implementation with new EnergiTokenUpgrade contract
   */

  it('Upgrade EnergiToken implementation with new EnergiTokenUpgrade contract', async () => {
    ...
    await impl.burn(vault, OTHER_TEST_AMOUNT) // Burn TEST_AMOUNT from wallet
